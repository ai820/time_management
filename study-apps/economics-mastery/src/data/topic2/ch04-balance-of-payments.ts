...
export const questions: PracticeQuestion[] = [
  ...
  {
    id: 'ch04-q006', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 1, marks: 1,
    question: "Which of the following is NOT a component of the current account?",
    options: [
      { label: 'a', text: 'Net goods' },
      { label: 'b', text: 'Net services' },
      { label: 'c', text: 'Net primary income' },
      { label: 'd', text: 'Direct investment' },
    ],
    correctOption: 'd',
  },
  {
    id: 'ch04-q007', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 1, marks: 1,
    question: "Net secondary income in the balance of payments includes:",
    options: [
      { label: 'a', text: 'Interest payments on foreign debt' },
      { label: 'b', text: 'Workers\' remittances and unconditional foreign aid' },
      { label: 'c', text: 'Dividends paid to foreign shareholders' },
      { label: 'd', text: 'Foreign direct investment by Australian firms' },
    ],
    correctOption: 'b',
  },
  {
    id: 'ch04-q008', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 2, marks: 1,
    question: "In 2019-20, Australia's net primary income was:",
    options: [
      { label: 'a', text: '+$40.2 billion (surplus)' },
      { label: 'b', text: '-$77.4 billion (deficit)' },
      { label: 'c', text: '-$40.2 billion (deficit)' },
      { label: 'd', text: '-$1.4 billion (deficit)' },
    ],
    correctOption: 'c',
  },
  {
    id: 'ch04-q009', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 2, marks: 1,
    question: "Which component of the capital and financial account records foreign assets controlled by the Reserve Bank of Australia?",
    options: [
      { label: 'a', text: 'Portfolio investment' },
      { label: 'b', text: 'Direct investment' },
      { label: 'c', text: 'Financial derivatives' },
      { label: 'd', text: 'Reserve assets' },
    ],
    correctOption: 'd',
  },
  {
    id: 'ch04-q010', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 2, marks: 1,
    question: "If Australia's current account records a deficit of $30 billion and there are no net errors and omissions, the capital and financial account must show:",
    options: [
      { label: 'a', text: 'A deficit of $30 billion' },
      { label: 'b', text: 'A surplus of $30 billion' },
      { label: 'c', text: 'A balance of zero' },
      { label: 'd', text: 'A surplus of $60 billion' },
    ],
    correctOption: 'b',
  },
  {
    id: 'ch04-q011', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 2, marks: 1,
    question: "The Balance on Goods and Services (BOGS) in 2019-20 was a record surplus of $77.4 billion. This was primarily driven by:",
    options: [
      { label: 'a', text: 'A large surplus on net services, especially tourism revenues' },
      { label: 'b', text: 'A goods surplus of $70.5 billion combined with a net services surplus of $6.9 billion' },
      { label: 'c', text: 'A reduction in the net primary income deficit' },
      { label: 'd', text: 'Increased portfolio investment inflows from overseas' },
    ],
    correctOption: 'b',
  },
  {
    id: 'ch04-q012', chapter: '4.4', topic: "Balance of Payments", type: 'mcq', difficulty: 3, marks: 1,
    question: "Australia's savings-investment gap is considered the fundamental structural cause of its current account deficit because:",
    options: [
      { label: 'a', text: 'Domestic investment exceeds domestic savings, requiring overseas borrowing and asset sales that generate future NPY debits' },
      { label: 'b', text: 'The government budget deficit is always larger than the current account deficit' },
      { label: 'c', text: 'Australian firms refuse to invest domestically, preferring to invest overseas' },
      { label: 'd', text: 'High domestic savings force banks to lend to foreign borrowers, creating NPY credits' },
    ],
    correctOption: 'a',
  },
  {
    id: 'ch04-q013', chapter: '4.4', topic: "Balance of Payments", type: 'short', difficulty: 2, marks: 4,
    question: "Outline the five components of the financial account in the balance of payments and state the 2019-20 value of each.",
    keyPoints: [
      "Direct investment: +$27.6bn surplus (long-term ownership stakes)",
      "Portfolio investment: -$29.7bn deficit (shares, bonds — shorter-term)",
      "Financial derivatives: +$4.8bn",
      "Reserve assets: +$18.5bn (foreign assets controlled by RBA)",
      "Other investment: -$55.8bn (trade credits, loans, deposits)",
      "Total financial account: -$34.6bn",
    ],
    modelAnswer: "The financial account within the capital and financial account has five components. Direct investment — long-term ownership stakes in businesses — recorded a surplus of $27.6 billion in 2019-20. Portfolio investment (shares, bonds and other securities) recorded a deficit of $29.7 billion. Financial derivatives (contracts whose value derives from an underlying asset) recorded a surplus of $4.8 billion. Reserve assets — foreign financial assets available to and controlled by the Reserve Bank of Australia for financing payment imbalances — recorded $18.5 billion. Other investment (including trade credits, loans and bank deposits) recorded a deficit of $55.8 billion. These five components summed to a total financial account balance of -$34.6 billion in 2019-20.",
  },
  {
    id: 'ch04-q014', chapter: '4.4', topic: "Balance of Payments", type: 'short', difficulty: 2, marks: 4,
    question: "Distinguish between the current account and the capital and financial account in the balance of payments, providing two examples of transactions recorded in each.",
    keyPoints: [
      "Current account records non-reversible flows: exports/imports of goods and services, primary income, secondary income",
      "KFA records reversible financial flows: borrowing, lending, buying/selling assets",
      "CA examples: export of iron ore (credit); interest paid to foreign lenders (debit)",
      "KFA examples: foreign firm purchasing Australian mine stake (credit); Australian company investing overseas (debit)",
      "Under floating exchange rate, CA + KFA + net errors and omissions = 0",
    ],
    modelAnswer: "The current account records all non-reversible international transactions over a given year, including exports and imports of goods and services, net primary income (interest and dividends), and net secondary income (remittances and foreign aid). Examples include an export of Australian iron ore to China (a current account credit) and interest paid on foreign debt to overseas lenders (a current account debit). The capital and financial account records reversible financial flows — borrowing, lending, and buying or selling assets. Examples include a foreign firm acquiring a stake in an Australian mine (a KFA credit) and an Australian company investing in an overseas subsidiary (a KFA debit). Under a floating exchange rate, these two accounts must balance: CA + KFA + net errors and omissions = 0.",
  },
  {
    id: 'ch04-q015', chapter: '4.4', topic: "Balance of Payments", type: 'short', difficulty: 3, marks: 6,
    question: "Using the formula CA + KFA = 0, explain how a sustained KFA surplus contributes to a widening current account deficit over time.",
    keyPoints: [
      "CA deficit → must be financed by KFA surplus (foreign borrowing or asset sales)",
      "KFA inflows create foreign liabilities: debt generates interest obligations (NPY debit); equity generates dividend obligations (NPY debit)",
      "Growing stock of foreign liabilities → larger NPY outflows each year → worsens CA",
      "This self-reinforcing cycle is the 'debt trap': borrowing to service existing debt",
      "Compulsory superannuation and fiscal consolidation are policies to reduce reliance on overseas capital",
    ],
    modelAnswer: "Under a floating exchange rate, the current account (CA) and capital and financial account (KFA) must sum to zero: CA + KFA + net errors and omissions = 0. When Australia runs a current account deficit, it must attract a matching KFA surplus — borrowing from overseas lenders or selling equity stakes in Australian assets to foreign investors. However, these KFA inflows create future obligations: foreign debt requires interest payments, and foreign equity generates dividend outflows. Both appear as debits on the net primary income account within the current account. As Australia's stock of foreign liabilities grows year after year, the NPY deficit widens, which itself worsens the current account deficit, requiring an even larger KFA surplus the following year. If this cycle accelerates, it can become a 'debt trap' where Australia borrows merely to cover the interest-servicing costs on its existing foreign debt, creating a self-reinforcing spiral of rising foreign liabilities.",
  },
];
